...
public class MindThief implements CardInterface {
	...
	public CardDataObject getTop(int id) {
		...
		switch(id) {
			...
			case 5:
				top.initiative=82;
				top.text="Summon Rat Swarm. Xp +2. Cont. Then consumed on discard.";
				top.experience=2;
				top.continuous=true;
				top.lost=true;
			case 6:
			...
			case 9:
				top.initiative=8;
				top.text="Attack +3. Add +2 Attack and gain XP +1 for each negative condition on target.(UNIMPLEMENTED)";
				top.attack=3;
				top.addNegativesToAttack=true;
			case 10:
				top.initiative=11;
